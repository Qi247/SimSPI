...
def process(owner, repo, commit_ID):
...
if __name__ == "__main__":
    ...
    files = sorted(os.listdir("raw_patch"))
    for file in files[1000:2000]:
        process("qemu", "qemu", file)
